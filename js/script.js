...
$(document).ready(function() {
    $('#sendData').on('click', function(event) {
        ...
        var nomFichier = $(this).data('filename'); // Récupère le nom du fichier via la data de filename

        $.ajax({
            url: "index.php?action=getExcel&nomFichier=" + encodeURIComponent(nomFichier),
            type: "GET",
